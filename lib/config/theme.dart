...
/// Modern color palette inspired by palm/sawit with vibrant greens
class AppColors {
  // Primary Colors - Vibrant Green Palette
  static const Color primary = Color(0xFF2D5016); // Dark Forest Green
  static const Color primaryLight = Color(0xFF4A7C2C); // Medium Green
  static const Color primaryDark = Color(0xFF1A3010); // Very Dark Green

  // Secondary Colors
  static const Color secondary = Color(0xFF6B8E23); // Olive Green
  static const Color secondaryLight = Color(0xFF8FB339); // Light Olive

  // Accent Colors
  static const Color accent = Color(0xFFFFB300); // Golden Yellow
...
/// Modern theme configuration with Material 3
class AppTheme {
